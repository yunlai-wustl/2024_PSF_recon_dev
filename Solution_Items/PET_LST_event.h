...
{
public:
	PET_LST_event(int id1, int id2, double tof, float t,  float rs) : src_id(id1), dest_id(id2), TOF_dist(tof), t0(t), random_scatter_correction_factor(rs){}
	
	PET_LST_event(int id1, int id2, double tof, float t,   float rs, float bed_position ) : \
		src_id(id1), dest_id(id2), TOF_dist(tof), t0(t),  random_scatter_correction_factor(rs), bed_position(bed_position){}
	...
	float random_scatter_correction_factor; //sum of scatter and random fraction
