...
#define MAX_NUM_LST_EVENT 1500000000
#define SMALLEST_ALLOWED 1e-38
#define MAX_GPU 8
...
typedef struct {
	...
	float global_norm_factor_ss;
	float global_norm_factor_os;
	float global_norm_factor_oo;

	int X_SAMP_DOWN_SAMPLED_FOR_SSS;
	int Y_SAMP_DOWN_SAMPLED_FOR_SSS;
	int Z_SAMP_DOWN_SAMPLED_FOR_SSS;
