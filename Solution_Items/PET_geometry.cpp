...
PET_geometry::PET_geometry(const std::string config_file_name, const std::string detectors_file_name){
	...
	config.GetValue<float>("X_SAMP_DOWN_SAMPLED_FOR_SSS", X_SAMP_DOWN_SAMPLED_FOR_SSS);
	config.GetValue<float>("Y_SAMP_DOWN_SAMPLED_FOR_SSS", Y_SAMP_DOWN_SAMPLED_FOR_SSS);
	config.GetValue<float>("Z_SAMP_DOWN_SAMPLED_FOR_SSS", Z_SAMP_DOWN_SAMPLED_FOR_SSS);
	config.GetValue<float>("Chunk size for SSS", chunkSizeForSSS);
