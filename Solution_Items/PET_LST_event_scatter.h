...
{
public:
	PET_LST_event_scatter(int id1, int id2, double tof, float t, float bed_position, int norm, float scatter_coeff) : src_id(id1), dest_id(id2), TOF_dist(tof), t0(t), bed_position(bed_position), normfact(norm),sc_coeff(scatter_coeff){}
	int src_id;
	int dest_id;
