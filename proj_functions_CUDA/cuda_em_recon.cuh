...
public:
	...
	void ComputeScatterFraction(PET_geometry& geometry, PET_data& data, ImageArray<float>& Emission_Image, ImageArray<float>& Attenuation_Image, string datpath, string emission_data_filename);
